...
A3W_timeMultiplierNight = 20.0;     // Sets the speed of time between 8 PM and 5 AM
...
A3W_buildingLootChances = 100;      // Chance percentage that loot will spawn at each spot in a building (0 to 100)
